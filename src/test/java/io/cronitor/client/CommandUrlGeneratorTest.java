...
public class CommandUrlGeneratorTest {
    ...
    public void can_build_run_url() throws Exception {
        URL runURL = urlGenerator.buildURL(Command.RUN.getValue(), monitorKey, apiKey, null, null, null, null);
    ...
    public void can_build_complete_url() throws Exception {
        URL completeUrl = urlGenerator.buildURL(Command.COMPLETE.getValue(), monitorKey, apiKey, null, null, null, null);
    ...
    public void can_build_tick_url() throws Exception {
        URL completeUrl = urlGenerator.buildURL(null, monitorKey, apiKey, null, null, null, null);
    ...
    public void can_build_tick_with_message_url() throws Exception {
        URL completeUrl = urlGenerator.buildURL(null, monitorKey, apiKey, null, "customMessage", null, null);
    ...
    public void can_build_ok_url() throws Exception {
        URL completeUrl = urlGenerator.buildURL(Command.OK.getValue(), monitorKey, apiKey, null, null, null, null);
    ...
    public void can_build_fail_url() throws Exception {
        URL fail = urlGenerator.buildURL(Command.FAIL.getValue(), monitorKey, apiKey, null, null, null, null);
    ...
    public void can_build_url_with_msg() throws Exception {
        URL runURL = urlGenerator.buildURL(Command.RUN.getValue(), monitorKey, apiKey, null, "customMessage", null, null);
    ...
    public void can_build_url_with_fallback_domain() throws Exception {
        URL runURL = fallbackUrlGenerator.buildURL(Command.RUN.getValue(), monitorKey, apiKey, null, null, null, null);
    ...
    public void can_build_url_without_https() throws Exception {
        URL runURL = httpUrlGenerator.buildURL(Command.RUN.getValue(), monitorKey, apiKey, null, null, null, null);
    ...
    public void can_build_url_with_env() throws Exception {
        URL runURL = urlGenerator.buildURL(Command.RUN.getValue(), monitorKey, apiKey, "beta", null, null, null);
    ...
    public void can_build_url_with_metrics() throws Exception {
        ...
        URL runURL = urlGenerator.buildURL(Command.COMPLETE.getValue(), monitorKey, apiKey, null, null, metrics, null);
    ...
    @Test
    public void can_build_url_with_series() throws Exception {
        String series = "123456";
        URL runURL = urlGenerator.buildURL(Command.COMPLETE.getValue(), monitorKey, apiKey, null, null, null, series);

        Assert.assertEquals(new URL(String.format(
                "https://cronitor.link/p/%s/%s?state=complete&series=123456", apiKey, monitorKey)), runURL);
    }
